								...
								<div class="card-inner">
									...
									<form class="form" action="#" method="POST" id="login-card">
										<div class="form-group form-group-label">
	                                        <div class="row">
													<div class="col-md-10 col-md-push-1">
														<label class="floating-label" for="input-firstname">First Name</label>
										...
										<div class="form-group form-group-label">
											<div class="row">
													<div class="col-md-10 col-md-push-1">
														<label class="floating-label" for="input-lastname">Last name</label>
										...
										<div class="form-group form-group-label">
											<div class="row">
													<div class="col-md-10 col-md-push-1">
														...
														<input class="form-control" id="input-emailaddress" type="text">
													</div>
											</div>
										</div>	
										<div class="form-group form-group-label">
											<div class="row">
													<div class="col-md-10 col-md-push-1">
														<label class="floating-label" for="input-telegram-no">Telephone-N0(telegram)</label>
														<input class="form-control" id="input-telegram-no" type="text">
													</div>
											</div>
										</div>	
